...
public class FormularioEventos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonOk.setOnClickListener(view -> {
            if(titulo.getText().toString().isEmpty() || detalles.getText().toString().isEmpty() || txtDate.getText().toString().isEmpty() || txtHour.getText().toString().isEmpty() || ubicacion.getText().toString().isEmpty()){
                Toast emptyFields =
